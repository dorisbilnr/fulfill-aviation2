...
(function () {
  ...
  function applyLang(lang) {
    ...
    /* Handle logo translation - nav + footer */
    document.querySelectorAll('.gn-logo, #footer-logo').forEach(function(logo) {
      if (!logo) return;
      if (lang === 'zh') {
        logo.innerHTML = '赋瞻<span>.</span>航空';
      } else {
        logo.innerHTML = 'FULFILL<span>.</span>AVIATION';
      }
    });
  }
